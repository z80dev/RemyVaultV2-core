...
abstract contract DerivativeTestUtils is Test {
    ...
    function predictDerivativeAddresses(DerivativeFactory factory, uint256 maxSupply, bytes32 salt)
        internal
        view
        returns (address nftAddress, address vaultAddress)
    {
    ...
    function mineSaltForToken1(DerivativeFactory factory, address targetToken, uint256 maxSupply, uint256 maxIterations)
        internal
        view
    ...
    function mineSaltForToken1(DerivativeFactory factory, address targetToken, uint256 maxSupply)
        internal
        view
        returns (bytes32)
    {
        return mineSaltForToken1(factory, targetToken, maxSupply, 10000);
    }
