 ...
 */
contract UniversalRouterMintOut is BaseTest {
    ...
    function test_QuoteETHToDerivativeMultihop() public {
        ...
        // Setup
        (address parentVault, PoolId rootPoolId, address derivativeVault, PoolId childPoolId) =
            _setupPools();
        ...
        IV4Quoter.QuoteExactParams memory quoteParams = IV4Quoter.QuoteExactParams({
            exactCurrency: CurrencyLibrary.ADDRESS_ZERO,
            path: path,
            exactAmount: 1 ether
        });
    ...
    function _setupPools() internal returns (
        address parentVault,
        PoolId rootPoolId,
