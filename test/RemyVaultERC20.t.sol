...
/**
 * @title IRemyVaultERC20
 * @dev Interface for the RemyVaultERC20 contract which is both the vault and ERC20 token
 */
interface IRemyVaultERC20 is IERC20 {
...
/**
 * @title RemyVaultERC20Test
 * @dev Comprehensive test suite for the RemyVaultERC20 contract
 *
 * This test suite validates all aspects of the RemyVaultERC20 protocol including:
 ...
 */
contract RemyVaultERC20Test is Test {
    ...
    /// @notice RemyVaultERC20 contract instance being tested (also the ERC20 token)
    IRemyVaultERC20 public vault;
     ...
     * 2. Deploys the RemyVaultERC20 contract which mints/burns its own ERC20 supply
    ...
    function setUp() public {
        ...
        vault = IRemyVaultERC20(deployCode("RemyVaultERC20", abi.encode("MOCK", "MOCK", address(nft))));
     ...
     *
     * This test ensures that the fundamental invariant of the RemyVaultERC20 protocol is maintained:
