...
interface IRescueRouter {
    ...
    function quote_swap_in_tokens(uint256[] calldata tokenIds_in, uint256[] calldata tokenIds_out) external view returns (uint256);
    function swap(uint256[] calldata tokenIds_in, uint256[] calldata tokenIds_out, address recipient) external payable;
